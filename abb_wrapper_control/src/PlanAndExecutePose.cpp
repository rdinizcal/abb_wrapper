...
PlanAndExecutePose::PlanAndExecutePose(AbbClient abb_client, tmp_traj_arm, waiting_time){
    this->abb_client = abb_client;
    this->tmp_traj_arm = tmp_traj_arm;
    this->waiting_time = waiting_time;
}

std_srvs::SetBool PlanAndExecutePose::operator()(geometry_msgs::Pose& pose, bool is_relative){
